...
public class SpuController {
    ...
    @ApiOperation("分页查询")
    public ResponseVo<PageResultVo> querySpusByCidPage(PageParamVo paramVo, @PathVariable("categoryId") Long categoryId) {
        PageResultVo pageResultVo = spuService.querySpusByCidPage(paramVo,categoryId);
