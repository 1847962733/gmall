...
public class CategoryController {
    ...
    @GetMapping("/lv1/{pid}")
    public ResponseVo<List<CategoryVo>> queryCategoryVosByPid(@PathVariable("pid")Long pid){
        List<CategoryVo> categoryEntityList = categoryService.queryCategoryVosByPid(pid);
